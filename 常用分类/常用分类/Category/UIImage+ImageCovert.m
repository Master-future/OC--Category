...
#import "UIImage+ImageCovert.h"

@implementation UIImage (ImageCovert)
...
- (UIImage *)convertImageWithSize:(CGSize)size {
    ...
    UIImage *convertImage = [UIImage imageWithCGImage:imageRef];
